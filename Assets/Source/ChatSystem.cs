...
public class ChatSystem : MonoBehaviour {
	...
	void Update () {
        Debug.Log("!POS:" + this.player.transform.position.x + "," + this.player.transform.position.z);
        _mumbleClient.SendTextMessage("!POS:" + this.player.transform.position.x + "," + this.player.transform.position.z);
	}
}
